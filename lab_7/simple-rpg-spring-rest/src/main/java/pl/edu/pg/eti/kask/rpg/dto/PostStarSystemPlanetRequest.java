...
@ToString
@EqualsAndHashCode
public class PostStarSystemPlanetRequest {
     ...
     */
    public static Function<PostStarSystemPlanetRequest, Planet> dtoToEntityMapper(Supplier<StarSystem> starSystemSupplier) {
        return request -> Planet.builder()
                .name(request.getName())
                .type(request.getType())
                .starSystem(starSystemSupplier.get())
                .build();
    }
